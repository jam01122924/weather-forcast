...
export class WeatherComponent implements OnInit {
  ...
  weather: any = {};
  futureWeather: any = {};
  futureWeatherTitle: string = 'Weather in 5 Days: (report every 3 hours)';
  date: Date = null;
  month: Array<string> = ['January','February','March','April','May','June','July','August','September','October','November','December'];
  day: Array<string> = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
  tempUnit: string = 'metric';
  weatherIconUrl: string = '';
  weatherBgCollection: any = {
    '01d': 'sun',
    '01n': 'night',
    '02d': 'cloud',
    '02n': 'cloud',
  ...
  getFutureWeather(city, country, unit) {
